...
<section class="formulario">
  ...
  <br></br>
<form action="confirmaciones/confirm_registro.php" method="POST" enctype="multipart/form-data">
  <div class="mb-3">
    ...
    <select name="id_dispositivo" id="id_dispositivo" class="form-control">
      <option value="#">Seleccione una dispositivo</option>
      <?php
  ...
  <div class="mb-3">
    <label for="id_definido" class="form-label">ID dispositivo: </label>
    <input type="text" class="form-control" name="id_definido" placeholder="Ingrese la id definida al dispositivo" autocomplete="off">
  </div>

  <div class="mb-3">
    <label for="marca" class="form-label">Marca: </label>
    <input type="text" class="form-control" name="marca" placeholder="Ingrese la marca del dispositivo" autocomplete="off">
  </div>

  <div class="mb-3">
    <label for="modelo" class="form-label">Modelo: </label>
    <input type="text" class="form-control" name="modelo" placeholder="Ingrese el modelo del dispositivo" autocomplete="off">
  </div>

  <div class="mb-3">
    <label for="caracteristicas" class="form-label">Caracteristicas: </label>
    <textarea name="caracteristicas" id="caracteristicas" class="form-control" placeholder="Por favor incluya las caracteristicas de hardware y software como RAM, procesador, sistema de tinta, etc." autocomplete="off"></textarea>
  </div>
  ...
  <input type="hidden" name="fecha_registro" value="<?php echo $fechaRegistro; ?>">
  <input type="hidden" name="fecha_edit" value="<?php echo $fechaEdit; ?>">
  <input type="hidden" name="persona_crea" value="<?php echo $nombre; ?>">
  <input type="hidden" name="persona_edit" value="<?php echo $nombre; ?>">
  <br>
